        ...
        stage("Release"){
            ...
            steps{
                ...
                withCredentials([usernamePassword( //jenisnya bisa liat di docs bawah apa saja selain usernamePassword(ditulis didalam array)
                    ...
                    bat('echo "Release it with -u %VAR_USER% -p %VAR_PASS%" > "release.txt"') //AKSES VARIABELNYA, dan sepertinya error karena ini pake bat bukan sh (kalau pakai bat kyknya pakai %NAMAVAR%) (COBA DEH)-->(IYA KALAU BAT PAKAI %NAMAVAR% KALAU SH PAKAI $NAMAVAR)
                }
            }
        }
